...
export default function InfoModal() {
  return (
    <>
      ...
      >
        <div class="w-80 bg-white rounded-xl shadow-[0px_8px_8px_-4px_rgba(16,24,40,0.04)] shadow-[0px_20px_24px_-4px_rgba(16,24,40,0.10)] inline-flex flex-col justify-start items-center overflow-hidden">
            ...
            <div class="self-stretch px-4 pt-5 bg-white flex flex-col justify-start items-start gap-3">
              <div class="self-stretch flex flex-col justify-start items-start gap-1">
                ...
                <div class="self-stretch text-slate-600 text-sm font-normal  leading-tight">
                  건물 내 휠체어 이용자를 위한 경사로 사진 혹은 승강기 운행
                  정보를 등록해주세요.
                </div>
              </div>
            </div>
            ...
            <div class="self-stretch flex flex-col justify-start items-start gap-4">
              <div class="self-stretch flex flex-col justify-start items-start gap-2">
                ...
                <div class="self-stretch inline-flex justify-start items-start gap-1">
                  <div
                    class="w-40 py-1 bg-amber-300 rounded shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] flex justify-center items-center overflow-hidden ramp-toggle"
                    data-value="true"
                  >
                  ...
                  <div
                    class="w-40 px-2 py-1 bg-gray-100 rounded shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] flex justify-center items-center gap-2 overflow-hidden ramp-toggle"
                    data-value="false"
                  >
                    <div class="text-gray-900 text-sm font-bold  leading-tight">
                      사용 불가
              ...
              <div class="self-stretch flex flex-col justify-start items-start gap-2">
                ...
                <div class="self-stretch inline-flex justify-start items-start gap-1">
                  <div
                    class="w-40 py-1 bg-amber-300 rounded shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] flex justify-center items-center overflow-hidden elevator-toggle"
                    data-value="true"
                  >
                    <div class="text-gray-900 text-sm font-bold  leading-tight">
                      사용 가능
                  ...
                  <div
                    class="w-40 px-2 py-1 bg-gray-100 rounded shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] flex justify-center items-center gap-2 overflow-hidden elevator-toggle"
                    data-value="false"
                  >
                    <div class="text-gray-900 text-sm font-bold  leading-tight">
                      사용 불가
